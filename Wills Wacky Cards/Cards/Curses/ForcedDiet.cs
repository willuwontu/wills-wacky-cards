...
{
    class ForcedDiet : CustomCard, ICurseCard, IConditionalCard
    {
        ...
        public bool Condition(Player player, CardInfo card)
        {
            ...
            if (player.data.maxHealth > 1000f)
            {
                return true;
            }
        ...
        {
            return "Let's trim a little off of you.";
        }
        ...
        {
            return CurseManager.CurseThemes.ToxicGreen;
        }
