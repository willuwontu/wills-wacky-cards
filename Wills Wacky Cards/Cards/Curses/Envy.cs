...
{
    class Envy : CustomCard, ICurseCard, IConditionalCard, ISaveableCard
    {
        ...
        public bool Condition(Player player, CardInfo card)
        {
            ...
            if (!(player.data.currentCards.Contains(Envy.card)))
            {
                return true;
            }
        ...
        {
            return "Their cards should be mine, only I deserve to have those cards, only I can use their full potential ...";
        }
