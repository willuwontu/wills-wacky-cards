...
{
    class Gluttony : CustomCard, ICurseCard, ISaveableCard
    {
        ...
        {
            characterStats.lifeSteal = -Mathf.Abs(characterStats.lifeSteal);
        ...
        {
            return "Though I've eaten a thousand meals, each one has only made me crave more ...";
        }
