...
{
    class Lust : CustomCard, ICurseCard, ISaveableCard
    {
        ...
        {
            return "Come friends, indulge in the pleasures of our bodies touching, feel the heat of passion flow between us.";
        }
